...
public abstract class BasicAnnotationProcessor extends AbstractProcessor {
  ...
  public final boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    for (Entry<String, Optional<? extends Element>> deferredTypeElementEntry :
      ...
      if (deferredElement.isPresent()) {
        findAnnotatedElements(deferredElement.get(), getSupportedAnnotationTypes(),
    ...
    ImmutableSetMultimap<String, Element> deferredElementsByAnnotation =
        deferredElementsByAnnotationBuilder.build();

    ImmutableSetMultimap.Builder<String, Element> elementsByAnnotationBuilder =
    ...
    for (String annotationClass : getSupportedAnnotationTypes()) {
      ...
      TypeElement annotationType = elements.getTypeElement(annotationClass);
    ...
    for (ProcessingStep step : steps) {
      SetMultimap<String, Element> filteredMap =
  ...
  private static void findAnnotatedElements(Element element,
      ...
      ImmutableSetMultimap.Builder<String, Element> builder) {
  ...
  public interface ProcessingStep {
     ...
     */
    void process(SetMultimap<String, Element> elementsByAnnotation);
  }
}
