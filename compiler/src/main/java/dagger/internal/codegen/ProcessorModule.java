...
/**
 * A Dagger {@link Module} that binds objects related to
 * {@link javax.annotation.processing.Processor} instances. Most callers will
 * create an instance using the {@link ProcessingEnvironment} passed into
 * {@link javax.annotation.processing.AbstractProcessor#init}.
 *
 * @author Gregory Kick
 */
@Module(library = true)
